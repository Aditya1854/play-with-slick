...
class StudentInfoRepositorySpec extends PlaySpec with GuiceOneAppPerTest {
  ...
  "Student repository" should {
    ...
    "get all data by which is created by specific user" in new WithStudentRepository() {
      val result = await(studentRepo.getAllByCreator("aditya@gmail.com"))
      result.length mustBe 2
      result.head._1 mustBe "Aditya"
    }
    ...
    "get single rows" in new WithStudentRepository() {
      ...
      result.get mustBe Student("Aditya","aditya@gmail.com",1,Date.valueOf("1995-05-03"),"aditya@gmail.com",Some(1))


    }

    "create a row" in new WithStudentRepository() {
      val student = Student("Abhijit","abhijit@gmail.com",1,Date.valueOf("1996-02-06"),"aditya@gmail.com")
    ...
    "update a row" in new WithStudentRepository() {
      val result = await(studentRepo.update(Student("Aditya","aditya@gmail.com",1,Date.valueOf("2005-05-03"),"aditya@gmail.com",Some(1)),"aditya@gmail.com"))
      result mustBe 1
    }

    "delete a row" in new WithStudentRepository() {
      val result = await(studentRepo.delete(1,"aditya@gmail.com"))
      result mustBe 1
    }
